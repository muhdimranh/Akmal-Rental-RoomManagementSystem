...
var pieChartSeries = salesByCategoryData;
...
var chart12 = new ApexCharts(
    document.querySelector("#sales-category"),
    options12
);
...
var options13 = {
    ...
    series: [{
        name: "Profit",
        data: Object.entries(profitByCategoryData).map(([category, profit]) => ({ x: category, y: profit }))
    }],

    xaxis: {
        categories: Object.keys(profitByCategoryData), // Assuming the keys represent the category names
    },
    colors: [vihoAdminConfig.primary]
};
...
var options14 = {
    ...
    subtitle: {
        text: 'Yearly Percentage',
        align: 'left'
    },
    labels: timelineLabelsData,
    xaxis: {
        type: 'datetime',
    },
    yaxis: {
...
console.log("salesGrowthRateData:", salesGrowthRateData);
console.log("timelineLabelsData:", timelineLabelsData);
console.log("options14:", options14);

var chart14 = new ApexCharts(
    document.querySelector("#sales-growth-rate"),
    options14
);

// Log the options14 object
console.log(options14);
...
var radarChartLabels = Object.keys(lossesByCategoryData);
var radarChartData = Object.values(lossesByCategoryData);
...
var chart15 = new ApexCharts(
    document.querySelector("#losses-category"),
    options15
);
